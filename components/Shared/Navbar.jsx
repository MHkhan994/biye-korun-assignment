    ...
    <nav className="my-container lg:mb-[24px] w-full bg-nav navbar h-[91px] flex items-center px-[20px] justify-between">
      <div>
        <Image
          ...
          width={173}
          height={44}
          className="w-[126px] h-[32px] navbar-img"
        />
      </div>
      <div className="flex gap-[15px]">
        <div
          className={`${navStyles.nav_button} lg:hidden flex justify-center items-center`}
        >
          <Image
            src={"/search-icon.png"}
            alt="search icon"
        ...
        <div
          className={`flex justify-center items-center ${navStyles.nav_button}`}
        >
          <Image
